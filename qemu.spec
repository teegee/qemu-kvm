...
Patch1: 0001-include-ui-rect.h-fix-qemu_rect_init-mis-assignment.patch

Patch2: 0001-i386-softmmu-Enable-PCNET-driver.patch
...
%autosetup -N -n qemu-%{version}%{?rcstr} -S git_am

# Patch0 breaks older versions of gcc
%if 0%{?rhel} > 9
%autopatch
%else
%autopatch -m 1
...
%changelog
* Wed Jan 17 2024 Peter Ajamian <pj@ghettoforge.org> - 2:8.2.0-1.2
- enable libblkio

* Tue Jan 16 2024 Peter Ajamian <pj@ghettoforge.org> - 2:8.2.0-1.1
- Rebuild for EL8 and 9.
- EL8 wants patches to be numbered.
